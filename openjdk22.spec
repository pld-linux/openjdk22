...
%define		_classdataversion 66.0

Summary:	Open-source implementation of the Java Platform, Standard Edition
Summary(pl.UTF-8):	Wolnoźródłowa implementacja Java 22 SE
Name:		openjdk22
Version:	22.0.2
Release:	3
License:	GPL v2
Group:		Development/Languages/Java
Source0:	https://github.com/openjdk/jdk22u/archive/jdk-%{version}-ga/%{name}-%{version}.tar.gz
...
OpenJDK components including the OpenJDK, Java 22 developement kit and
runtime environment.

%description -l pl.UTF-8
Wolnoźródłowa implementacja Java 22 SE.
...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk22-jdk < 22.0.2-2
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk22-jdk-base < 22.0.2-2
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk22-jre < 22.0.2-2
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk22-jre-base < 22.0.2-2
...
Obsoletes:	openjdk22-jre-base-X11 < 22.0.2-2
...
Obsoletes:	openjdk22-jre-base-freetype < 22.0.2-2
...
Obsoletes:	jar
Obsoletes:	openjdk22-jar < 22.0.2-2
